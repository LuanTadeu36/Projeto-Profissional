    ...
    <footer className="w-full z-50 bg-gray-50 text-preto border-t border-gray-200 opacity-90 text-xs py-2">
      <div className="max-w-screen-xl mx-auto flex flex-col md:flex-row items-center justify-between px-4 min-h-[40px] gap-2 md:gap-0">
        <div className="flex flex-wrap gap-4 items-center mb-1 md:mb-0">
          <a href="/privacidade" className="text-preto/70 hover:text-amarelo transition-colors">Política de Privacidade</a>
          <a href="/termos" className="text-preto/70 hover:text-amarelo transition-colors">Termos de Uso</a>
        ...
        <div className="flex gap-4 items-center mb-1 md:mb-0">
          <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-preto/70 hover:text-amarelo transition-colors">Instagram</a>
          <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="text-preto/70 hover:text-amarelo transition-colors">Facebook</a>
        </div>
